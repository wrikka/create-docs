...
export function SidebarNav(props: { open: boolean; onNavigate: () => void }) {
	...
	return (
		<aside
			class={`fixed top-[calc(3.5rem+var(--docs-banner-height,0px))] bottom-0 right-0 z-30 w-72 h-[calc(100vh-3.5rem-var(--docs-banner-height,0px))] shrink-0 border-l border-border bg-background overflow-y-auto transition-transform ${props.open ? "translate-x-0" : "translate-x-full"} lg:left-0 lg:right-auto lg:border-l-0 lg:border-r lg:border-r-border lg:translate-x-0`}
		>
